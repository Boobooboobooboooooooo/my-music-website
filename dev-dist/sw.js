...
define(['./workbox-f87553f6'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/Music\/.*\.(mp3|m4a|wav|flac|ogg|aac)$/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\/songs\.json$/i, new workbox.NetworkFirst({
